                ...
                <x-auth-validation-errors class="mb-4" :errors="$errors" />    
                    ...
                    @csrf
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    <label for="image" accept="image/png,image/jpeg,image/jpg" class="leading-7 text-sm text-gray-600">画像</label>
                            ...
                            <div class="p-2 w-full flex justify-center space-x-8 mt-4">
                                <button type="button" onclick="location.href='{{ route('owner.shops.index') }}'" class="bg-gray-100 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg">戻る</button>
