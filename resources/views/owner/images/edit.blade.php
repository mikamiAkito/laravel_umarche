                ...
                <x-auth-validation-errors class="mb-4" :errors="$errors" />    
                    ...
                    @method('put')
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-full flex justify-center space-x-8 mt-4">
                                <button type="button" onclick="location.href='{{ route('owner.images.index') }}'" class="bg-gray-100 border-0 py-2 px-8 focus:outline-none hover:bg-gray-700 rounded text-lg">戻る</button>
                    ...
                    <form id="delete_{{$image->id}}" method="post" action="{{ route('owner.images.destroy', ['image' => $image->id ] )}}">
                        ...
                        <div class="p-2 w-full flex justify-around mt-32">
                            <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" class="text-white bg-red-300 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded ">削除</a>
                        </div>
                    </form>
                </div>
            </div>
